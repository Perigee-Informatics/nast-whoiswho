...
try {
  ...
  __webpack_require__(/*! ./custom_scripts */ "./resources/js/custom_scripts.js");
} catch (e) {}
...
var NAST = {
  getDistrict: function getDistrict() {
    ...
    $('#filter_districtId').append('<option value="">-- Loading...  --</option>'); //first remove district and client params on change
  ...
  getFedLocalLevel: function getFedLocalLevel() {
    $.urlParam = function (name) {
      try {
        var results = new RegExp('[\?&]' + name + '=([^&#]*)').exec(window.location.href);
        return results[1] || 0;
    ...
    var district_id = $('#filter_districtId').val(); //first remove client params on change
...
__webpack_require__(/*! C:\laragon\www\nast\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\nast\resources\sass\app.scss */"./resources/sass/app.scss");
