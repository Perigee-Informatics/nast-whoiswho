...
/**
 * Class ProjectByCategoryCostChartController
 * @package App\Http\Controllers\Admin\Charts
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ProjectByCategoryCostChartController extends ChartController
{
    protected $new_datas;
    ...
    public function setup()
    {
        ...
        $this->chart->load(backpack_url('charts/project-by-category-cost'));
    ...
    public function response()
    {
        ...
        foreach($response as $key => $rd){
            ...
            $response[$key]->chart_name= 'project_by_category_cost';
        }
    ...
    public function data()
    {
        ...
        $category_costs = DB::table('pt_selected_project as pp')->select('mpc.name_lc','mpc.id as category_id',DB::raw('sum(pp.project_cost) as category_cost'))
        ...
        foreach($datas as $rows){
            foreach($rows as $row){
                ...
                $new_datas[$row->category_id]['data'][] = intval($row->category_cost);
